local keymaps = {
  ...
  { mode = 'n', shortcut = '<C-h>', fn = '<C-w>h', opts = { noremap = true } },
  { mode = 'n', shortcut = '<C-j>', fn = '<C-w>j', opts = { noremap = true } },
  { mode = 'n', shortcut = '<C-k>', fn = '<C-w>k', opts = { noremap = true } },
  { mode = 'n', shortcut = '<C-l>', fn = '<C-w>l', opts = { noremap = true } },

  { mode = 'n', shortcut = 'gs',    fn = '0', opts = { noremap = true }},
  { mode = 'n', shortcut = 'ge',    fn = '$', opts = { noremap = true }},
  ...
  { mode = 'n', shortcut = '<C-u>',        fn = '<C-u>zz'},
  { mode = 'n', shortcut = '<C-d>',        fn = '<C-d>zz'},
  ...
  { mode = 'n', shortcut = 'gr',           fn = ':Telescope lsp_references<CR>'},

  { mode = 'n', shortcut = '<leader>tt',   fn = ':NvimTreeToggle<CR>'},
  { mode = 'n', shortcut = '<leader>tr',   fn = ':NvimTreeRefresh<CR>'},
  { mode = 'n', shortcut = 'tf',           fn = ':NvimTreeFocus<CR>'},
  ...
  { mode = 'n', shortcut = '<C-k>',        fn = '":m .+1<CR>=="'},

  { mode = 'n', shortcut = 'ff',           fn = ':FormatWrite<CR>'},
  -- { mode = 'n', shortcut = 'ff',           fn = ':lua vim.lsp.buf.format()<CR>'},
...
for index in ipairs(keymaps) do
  ...
  vim.keymap.set(keymap.mode, keymap.shortcut, keymap.fn, keymap.opts)
end
